...
public class entityRegistry {
    ...
    static {
        ...
        INTRUDER_BARRIER = registry.register("intruder_barrier", () -> {
            return EntityType.Builder.<IntruderBarrier>of(IntruderBarrier::new, MobCategory.MISC).sized(0.1F, 0.1F).clientTrackingRange(64).updateInterval(Integer.MAX_VALUE).fireImmune().build((new ResourceLocation("trawakened", "intruder_barrier")).toString());
        });
    }
}
