...
public class conceptofinfinity extends Skill {
    ...
    public boolean meetEPRequirement(Player entity, double newEP) {
        return SkillUtils.hasSkill(entity, ExtraSkills.SAGE.get()) && (trawakenedPlayerCapability.isDemonLordSeed(entity) || trawakenedPlayerCapability.isHeroEgg(entity)) && !(SkillUtils.hasSkill(entity, skillRegistry.AZAZEL.get()) && SkillUtils.hasSkill(entity, skillRegistry.STARKILL.get()));
    }
