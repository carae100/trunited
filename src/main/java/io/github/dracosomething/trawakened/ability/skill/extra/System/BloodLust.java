    ...
    public void onPressed(ManasSkillInstance instance, LivingEntity entity) {
        ...
        for (Entity entity1 : list) {
            if (entity1 instanceof LivingEntity living) {
                living.addEffect(new MobEffectInstance(effectRegistry.BLOODLUST_DEBUFF.get(), -1, 1, false, false, false));
                living.addEffect(new MobEffectInstance(TensuraMobEffects.BURDEN.get(), -1, 0, false, false, false));
            }
        }
    }
}
